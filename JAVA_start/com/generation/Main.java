...
public class Main
{
    ...
    private static void gradeStudent( StudentService studentService, Scanner scanner )
    {
        ...
        double doubleGrade = scanner.nextDouble();
        if (doubleGrade >= 0 && doubleGrade <=6)
        {
           student.studentCourseGrade(courseId, doubleGrade);
        }
        else
            System.out.println( "Grade out of boundary. Please try again." );
